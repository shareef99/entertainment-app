...
import { useMovieDetail } from "@/app/(main)/movies/query";
...
export default function Page() {
  ...
  const { data, error } = useMovieDetail(id);
      ...
      <section className="w-full">
        ...
        <div className="mt-8 flex justify-between">
          <div className="flex flex-col gap-2">
            <span className="text-lg text-white/60">Length</span>
            <span className="text-xl">{data.runtime} min</span>
          </div>
          <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <span className="text-xl">{data.release_date.slice(0, 4)}</span>
          </div>
          <div className="flex flex-col gap-2">
